...
var field_info = {
    type: {
        grass: 'grass',
        grass_mntn: 'grass',
        mntn_small: 'mntn_small',
        tree: 'tree',
        water: 'water',
        water_left: 'water',
        water_top: 'water',
        water_top_right: 'water',
        water_top_left: 'water',
        water_right: 'water',
        water_bottom_right: 'water',
        water_bottom: 'water',
        water_bottom_left: 'water',
        marsh: 'marsh',
        road_h: 'road_h'
    },
    def: {
...
var unit_info = {
    type: {
        mech_left: 'mech_left',
        soldier_left: 'soldier_left',
        tank_left: 'tank_left',
        transport_heli_left: 'transport_heli_left'
    },
    title: {
        mech_left: 'Mech',
        soldier_left: 'Inftry',
        tank_left: 'Tank',
        transport_heli_left: 'T Cptr'
    }
}
...
var current_layout = { select_pos: [3, 0, 10] };
//Level 1 Map Layout
var level1_layout = {
    field: [
