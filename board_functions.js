...
function title_screen() {
    $('#title_board').append('<div>"Title Screen"</div>').append('<div>Select a Level and Press X</div>').append('<br />').append('<div class="lvl1">Level 1</div>').append('<div class="lvl2">Level 2</div>').append('<br />').append('<br />').append('<div>\'x\' = Enter</div>').append('<div>\'c\' = Back</div>');;
}
...
function field_details() {
    $('#field_info').empty();
    //switch statement based on if it should use the current position or the selected position.
    switch (button_phase.level) {
        case 4:
        case 2:
        case 0:
            $('#field_info').append('<div class="field_title">' + field_info.title[field_info.type[current_layout.field[current_layout.select_pos[1]][current_layout.select_pos[0]]]] + '</div>');
            $('#field_info').append('<div class="field_example ' + field_info.type[current_layout.field[current_layout.select_pos[1]][current_layout.select_pos[0]]] + '"></div>');
            $('#field_info').append('<div class="field_text">Def ' + field_info.def[field_info.type[current_layout.field[current_layout.select_pos[1]][current_layout.select_pos[0]]]] + '</div>');
            break;
        case 1:
            $('#field_info').append('<div class="field_title">' + field_info.title[field_info.type[current_layout.field[current_layout.move_pos[1]][current_layout.move_pos[0]]]] + '</div>');
            $('#field_info').append('<div class="field_example ' + field_info.type[current_layout.field[current_layout.move_pos[1]][current_layout.move_pos[0]]] + '"></div>');
            $('#field_info').append('<div class="field_text">Def ' + field_info.def[field_info.type[current_layout.field[current_layout.move_pos[1]][current_layout.move_pos[0]]]] + '</div>');
            break;
        case 3:
            $('#field_info').append('<div class="field_title">' + field_info.title[field_info.type[current_layout.field[current_layout.attack_pos[1]][current_layout.attack_pos[0]]]] + '</div>');
            $('#field_info').append('<div class="field_example ' + field_info.type[current_layout.field[current_layout.attack_pos[1]][current_layout.attack_pos[0]]] + '"></div>');
            $('#field_info').append('<div class="field_text">Def ' + field_info.def[field_info.type[current_layout.field[current_layout.attack_pos[1]][current_layout.attack_pos[0]]]] + '</div>');
            break;
    }
    ...
    switch (button_phase.level) {
        ...
        case 0:
            if (!jQuery.isEmptyObject(current_layout.unit[current_layout.select_pos[1]][current_layout.select_pos[0]])) {
                $('#unit_info').show();
                $('#unit_info').append('<div class="field_title">' + unit_info.title[current_layout.unit[current_layout.select_pos[1]][current_layout.select_pos[0]].image] + '</div>');
                $('#unit_info').append('<div class="field_example ' + current_layout.unit[current_layout.select_pos[1]][current_layout.select_pos[0]].image + '"></div>');
                $('#unit_info').append('<div class="field_text">Hp ' + current_layout.unit[current_layout.select_pos[1]][current_layout.select_pos[0]].cur_hp + '</div>');
            }
            else {
                $('#unit_info').hide();
            }
        ...
        case 1:
            if (!jQuery.isEmptyObject(current_layout.unit[current_layout.move_pos[1]][current_layout.move_pos[0]])) {
                $('#unit_info').show();
                $('#unit_info').append('<div class="field_title">' + unit_info.title[current_layout.unit[current_layout.move_pos[1]][current_layout.move_pos[0]].image] + '</div>');
                $('#unit_info').append('<div class="field_example ' + current_layout.unit[current_layout.move_pos[1]][current_layout.move_pos[0]].image + '"></div>');
                $('#unit_info').append('<div class="field_text">Hp ' + current_layout.unit[current_layout.move_pos[1]][current_layout.move_pos[0]].cur_hp + '</div>');
            }
            else {
                $('#unit_info').hide();
            }
            break;
        case 3:
            if (!jQuery.isEmptyObject(current_layout.unit[current_layout.attack_pos[1]][current_layout.attack_pos[0]])) {
                $('#unit_info').show();
                $('#unit_info').append('<div class="field_title">' + unit_info.title[current_layout.unit[current_layout.attack_pos[1]][current_layout.attack_pos[0]].image] + '</div>');
                $('#unit_info').append('<div class="field_example ' + current_layout.unit[current_layout.attack_pos[1]][current_layout.attack_pos[0]].image + '"></div>');
                $('#unit_info').append('<div class="field_text">Hp ' + current_layout.unit[current_layout.attack_pos[1]][current_layout.attack_pos[0]].cur_hp + '</div>');
            }
            else {
                $('#unit_info').hide();
            }
